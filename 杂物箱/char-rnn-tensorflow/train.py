...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        help="""
        continue training from saved model at this path. Path must contain\
        files saved by previous training process:
...
def train(args):
    ...
    args.vocab_size = data_loader.vocab_size  # 词的数量
    ...
    if not os.path.isdir(args.save_dir):  # 若保存文件夹为空，创建
